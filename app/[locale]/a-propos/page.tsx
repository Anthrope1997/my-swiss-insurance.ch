    ...
    <>
      ...
      <div className="container-xl py-16 max-w-3xl">
        ...
        <div className="space-y-10 text-[16px] text-slate leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-semibold text-brand mb-3">Notre équipe</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-brand mb-3">Nos données</h2>
            <p>
          ...
          <section>
            <h2 className="text-xl font-semibold text-brand mb-3">Contact</h2>
            <p>
              Email :{' '}
          ...
          <section>
            <h2 className="text-xl font-semibold text-brand mb-3">Conformité</h2>
            <p>
