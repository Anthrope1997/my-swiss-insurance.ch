...
export default function MentionsLegalesPage() {
  return (
    <div className="container-xl py-16 max-w-3xl">
      ...
      <h1 className="text-4xl font-bold text-brand mb-2">Mentions légales</h1>
      ...
      <div className="space-y-10 text-[15px] text-slate leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-brand mb-3">Éditeur du site</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-brand mb-3">Objet du service</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-brand mb-3">Droit applicable</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-brand mb-3">Protection des données</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-brand mb-3">Propriété intellectuelle</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-brand mb-3">Sources des données</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-brand mb-3">Limitation de responsabilité</h2>
          <p>
