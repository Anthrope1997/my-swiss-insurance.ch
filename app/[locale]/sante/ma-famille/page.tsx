...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://my-swiss-insurance.ch/sante/ma-famille',
    type: 'article',
  },
  alternates: { canonical: 'https://my-swiss-insurance.ch/sante/ma-famille' },
}
...
const articleSchema = {
  ...
  mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://my-swiss-insurance.ch/sante/ma-famille' },
}
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  ...
                  { href: '/sante/lamal-vs-lca', label: 'LAMal vs assurance complémentaire LCA'      },
