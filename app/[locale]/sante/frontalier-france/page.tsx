...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://my-swiss-insurance.ch/sante/frontalier-france' },
}
...
const articleSchema = {
  ...
  mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://my-swiss-insurance.ch/sante/frontalier-france' },
}
      ...
      <section className="bg-white border-b border-edge pt-12 pb-14">
        <div className="container-xl">
          ...
          <p className="text-[16px] text-slate max-w-2xl leading-relaxed mb-10">
            ...
            Neuchâtel, Jura ou Valais disposent d&apos;un droit d&apos;option entre l&apos;assurance maladie de base LAMal
      ...
      <div className="container-xl py-12">
        <article className="space-y-4">
            ...
            <section id="primes">
              ...
              <p className="article-p">
                Adulte de 35 ans, franchise de CHF 300, modèle standard, données OFSP 2026.
