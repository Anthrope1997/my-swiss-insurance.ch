...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://my-swiss-insurance.ch/sante/lamal-vs-lca',
    type: 'article',
  },
  alternates: { canonical: 'https://my-swiss-insurance.ch/sante/lamal-vs-lca' },
}
      ...
      <div className="container-xl py-12">
        <article className="space-y-4">
            ...
            <section id="quand">
              ...
              <KeyFact>
                <strong>Le moment de souscription compte :</strong>{' '}
