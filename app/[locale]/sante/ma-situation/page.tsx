...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    url: 'https://my-swiss-insurance.ch/sante/ma-situation',
    type: 'article',
  },
  alternates: { canonical: 'https://my-swiss-insurance.ch/sante/ma-situation' },
}
...
const articleSchema = {
  ...
  mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://my-swiss-insurance.ch/sante/ma-situation' },
}
        ...
        <article className="space-y-4">
            ...
            <section>
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                {[
                  { href: '/sante/ma-famille', label: 'LAMal pour votre famille'   },
                  { href: '/sante/frontalier', label: 'LAMal pour les frontaliers' },
                  { href: '/sante/franchise',  label: 'Choisir sa franchise LAMal' },
