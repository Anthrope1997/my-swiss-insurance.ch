...
export const metadata: Metadata = {
  ...
  alternates: { canonical: 'https://my-swiss-insurance.ch/sante/frontalier-allemagne' },
}
...
const articleSchema = {
  ...
  mainEntityOfPage: { '@type': 'WebPage', '@id': 'https://my-swiss-insurance.ch/sante/frontalier-allemagne' },
}
      ...
      <section className="bg-white border-b border-edge pt-12 pb-14">
        <div className="container-xl">
          ...
          <p className="text-[16px] text-slate max-w-2xl leading-relaxed mb-10">
            ...
            d&apos;option entre l&apos;assurance maladie de base LAMal et le système d&apos;assurance maladie légale allemand (GKV).
