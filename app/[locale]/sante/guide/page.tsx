...
const enBref = [
  ...
  <>{"Économisez jusqu'à "}
    <strong className="font-medium text-ink">{`CHF ${formatChf(ecartMaxProfil().montantAnnuel)} par an`}</strong>
        ...
        <article className="space-y-4">
            ...
            <section id="couverture">
              ...
              <KeyFact>
                ...
                <p>Contrairement à l&apos;assurance de base LAMal, une complémentaire sélectionne ses clients. Le montant des primes dépend de votre âge, de votre état de santé, ainsi que de votre canton de résidence.</p>
              </KeyFact>
