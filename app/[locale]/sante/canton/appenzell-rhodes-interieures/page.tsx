...
export const metadata: Metadata = {
  ...
  description: `Prime moyenne ${canton.primeMoyenne} CHF par mois dans le canton d'Appenzell Rhodes-Intérieures. Caisse la moins chère : ${canton.topCaisses[0].name} dès ${canton.topCaisses[0].prime} CHF par mois. Économie max : CHF ${canton.economieAn}/an. Données OFSP 2026.`,
  alternates: { canonical: 'https://my-swiss-insurance.ch/sante/canton/appenzell-rhodes-interieures' },
  openGraph: {
    title: `Assurance maladie dans le canton d'Appenzell Rhodes-Intérieures 2026 : primes, caisses et subsides`,
    ...
    url: 'https://my-swiss-insurance.ch/sante/canton/appenzell-rhodes-interieures',
    type: 'article',
  },
}
