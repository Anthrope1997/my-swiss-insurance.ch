      ...
      <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-3 mb-12">
        {cantons.map((canton) => (
          <Link
            ...
            className="flex items-center gap-3 px-4 py-3 rounded-lg border border-edge bg-white hover:border-brand hover:bg-blue-hint transition-colors duration-150 group"
          >
            <span className="w-9 h-9 rounded-md bg-cloud flex items-center justify-center shrink-0 text-[11px] font-bold text-slate group-hover:bg-blue-tint group-hover:text-brand transition-colors duration-150">
              {canton.code}
            </span>
