...
const guides = [
  ...
  },
  {
    ...
    desc: 'Standard, médecin de famille, centre médical, télémédecine : jusqu\'à 22 % d\'économie sur la prime',
    href: '/sante/modeles',
  },
  {
    icon: (
    ...
    <>
      ...
      <section className="bg-white pt-20 pb-16 sm:pt-28 sm:pb-20">
        <div className="container-xl">
          ...
          {/* Stats */}
          <HeroStats stats={stats} className="hero-stats" />
      ...
      {/* ── 6. FORMULAIRE ───────────────────────────────────────────────────── */}
      <section id="formulaire" className="bg-cloud border-y border-edge">
