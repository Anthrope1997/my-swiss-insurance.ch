      ...
      <div className="container-xl py-16">
        ...
        <div className="flex gap-12">
          <div className="flex-1 min-w-0 space-y-14">
            ...
            {/* Cantons concernés */}
            <section id="qui">
              <h2 className="text-2xl font-semibold text-ink mb-4">Cantons suisses et accords bilatéraux applicables</h2>
            ...
            <section id="comparaison">
              <h2 className="text-2xl font-semibold text-ink mb-4">LAMal suisse vs SSN italien : comparaison</h2>
            ...
            <section id="option-lamal">
              <h2 className="text-2xl font-semibold text-ink mb-4">Choisir la LAMal suisse</h2>
            ...
            <section id="option-ssn">
              <h2 className="text-2xl font-semibold text-ink mb-4">Choisir le SSN avec le formulaire S1</h2>
              <p className="text-[16px] text-slate leading-relaxed mb-5">
