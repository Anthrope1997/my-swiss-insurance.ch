...
export const metadata: Metadata = {
  title: 'Assurance maladie dans le canton de Appenzell Rhodes-Extérieures — My Swiss Insurance',
  robots: { index: false },
}
  ...
  return (
    <main className="min-h-screen bg-white flex items-center justify-center px-4">
      <div className="text-center">
        ...
        <h1 className="text-4xl font-bold text-brand mb-4">Canton de Appenzell Rhodes-Extérieures</h1>
