...
const cantons: Canton[] = [
  ...
  /* ─── ZG — ZOUG ──────────────────────────────────── */
  {
    ...
    subside: {
      ...
      tableauProfils: [
        { profil: 'Adulte seul (≥ 26 ans)',   subsideMax: '415 CHF/mois', revenuMax: '75 000 CHF/an' },
  ...
  /* ─── AI — APPENZELL RHODES-INTÉRIEURES ──────────── */
  {
    ...
    subside: {
      ...
      tableauProfils: [
        { profil: 'Adulte seul (≥ 26 ans)',   subsideMax: '387 CHF/mois', revenuMax: '44 000 CHF/an' },
  ...
  /* ─── NW — NIDWALD ───────────────────────────────── */
  {
    ...
    subside: {
      ...
      tableauProfils: [
        { profil: 'Adulte seul (≥ 26 ans)',   subsideMax: '450 CHF/mois', revenuMax: '50 000 CHF/an' },
  ...
  /* ─── UR — URI ───────────────────────────────────── */
  {
    ...
    subside: {
      ...
      tableauProfils: [
        { profil: 'Adulte seul (≥ 26 ans)',              subsideMax: '364 CHF/mois', revenuMax: '48 000 CHF/an' },
  ...
  /* ─── OW — OBWALD ────────────────────────────────── */
  {
    ...
    subside: {
      ...
      tableauProfils: [
        { profil: 'Adulte seul (≥ 26 ans)',   subsideMax: '418 CHF/mois', revenuMax: '48 000 CHF/an' },
  ...
  /* ─── SZ — SCHWYZ ────────────────────────────────── */
  {
    ...
    subside: {
      ...
      tableauProfils: [
        { profil: 'Adulte seul (≥ 26 ans)',   subsideMax: '465 CHF/mois', revenuMax: '55 000 CHF/an' },
  ...
  /* ─── SG — SAINT-GALL ────────────────────────────── */
  {
    ...
    subside: {
      ...
      tableauProfils: [
        { profil: 'Adulte seul (≥ 26 ans)',   subsideMax: '524 CHF/mois', revenuMax: '41 700 CHF/an' },
        { profil: 'Jeune adulte (19–25 ans)',  subsideMax: '374 CHF/mois', revenuMax: '41 700 CHF/an' },
  ...
  /* ─── LU — LUCERNE ───────────────────────────────── */
  {
    ...
    subside: {
      ...
      tableauProfils: [
        { profil: 'Adulte seul (≥ 26 ans)',   subsideMax: '469 CHF/mois', revenuMax: '58 000 CHF/an' },
  ...
  /* ─── TG — THURGOVIE ─────────────────────────────── */
  {
    ...
    subside: {
      ...
      tableauProfils: [
        { profil: 'Adulte seul (≥ 26 ans)',              subsideMax: '284 CHF/mois', revenuMax: '55 000 CHF/an' },
        { profil: 'Jeune adulte (19–25 ans, formation)', subsideMax: '198 CHF/mois', revenuMax: '55 000 CHF/an' },
        { profil: 'Enfant (0–18 ans)',                   subsideMax: '103 CHF/mois', revenuMax: '55 000 CHF/an' },
      ],
    },
  },
  ...
  /* ─── GR — GRISONS ───────────────────────────────── */
  {
    ...
    subside: {
      ...
      tableauProfils: [
        { profil: 'Adulte seul (≥ 26 ans)',  subsideMax: '493 CHF/mois', revenuMax: '52 000 CHF/an' },
  ...
  /* ─── AG — ARGOVIE ───────────────────────────────── */
  {
    ...
    subside: {
      ...
      bareme: [
        ...
        { revenu: '30 000 – 44 000 CHF', montant: "jusqu'à 172 CHF / mois"  },
        { revenu: 'Plus de 44 000 CHF',  montant: 'Non éligible'            },
      ],
      tableauProfils: [
        { profil: 'Adulte seul (≥ 26 ans)',              subsideMax: '486 CHF/mois', revenuMax: '44 000 CHF/an' },
  ...
  /* ─── SH — SCHAFFHOUSE ───────────────────────────── */
  {
    ...
    subside: {
      ...
      tableauProfils: [
        { profil: 'Adulte seul (≥ 26 ans)',  subsideMax: '322 CHF/mois', revenuMax: '54 000 CHF/an' },
  ...
  /* ─── SO — SOLEURE ───────────────────────────────── */
  {
    ...
    subside: {
      ...
      subsideMensuel: 'Variable selon le revenu',
      subsideMensuelMax: 422,
      automatique: false,
      delai: '31 oct. 2026',
      lienOfficiel: 'https://www.so.ch',
      tableauProfils: [
        { profil: 'Adulte seul (≥ 26 ans)',              subsideMax: '422 CHF/mois', revenuMax: '57 000 CHF/an' },
  ...
  /* ─── BS — BÂLE-VILLE ────────────────────────────── */
  {
    ...
    subside: {
      ...
      tableauProfils: [
        { profil: 'Adulte seul (≥ 26 ans)',  subsideMax: '444 CHF/mois', revenuMax: '49 000 CHF/an' },
