      ...
      {mobileOpen && (
        <div className="menu-slide bg-[#0f2040]/95 backdrop-blur-sm border-t border-white/10
          ...
          <Link href="/lamal" onClick={close}
            className="flex items-center gap-3 py-3 text-[15px] text-white hover:text-blue-300 border-b border-white/10">
            ...
            <div className="bg-white/5 border-b border-white/10">
              {situationLinks.map(link => (
                <Link key={link.href} href={link.href} onClick={close}
                  className="flex items-center gap-3 pl-5 py-2.5 text-[14px] text-white hover:text-blue-300 border-b border-white/5 last:border-0">
          ...
          {expandedSection === 'canton' && (
            <div className="bg-white/5 border-b border-white/10">
              {hamburgerCantonLinks.map(link => (
                <Link key={link.href} href={link.href} onClick={close}
                  className="block pl-5 py-2.5 text-[14px] text-white hover:text-blue-300 border-b border-white/5">
                  {link.label}
                </Link>
              ))}
