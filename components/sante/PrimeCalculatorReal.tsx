          ...
          >
            ...
            <div className="flex items-center justify-between px-6 py-5 border-b border-edge">
              ...
              <button
                type="button"
                onClick={() => setShowModeleInfo(false)}
                className="w-9 h-9 rounded-full flex items-center justify-center text-brand hover:bg-blue-tint transition-colors"
                aria-label="Fermer"
              >
                ...
                <table className="stripe-table w-full">
                  ...
                  <tbody>
                    {visibleResults!.map((row, i) => {
                      ...
                      return (
                        <tr key={i} className={i === 0 ? 'bg-blue-tint' : ''}>
                          <td>
                            <span className={`inline-flex items-center justify-center w-6 h-6 rounded-full text-[12px] font-bold ${i === 0 ? 'bg-brand text-white' : 'bg-cloud text-slate'}`}>
                              {i + 1}
                            </span>
                          </td>
