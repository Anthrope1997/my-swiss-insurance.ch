...
export default function FrontalierSimulateur() {
  ...
  if (resultat) {
    const colors = {
      lamal: { bg: 'bg-blue-light2', border: 'border-brand', text: 'text-brand', icon: '✓' },
      pays: { bg: 'bg-blue-tint', border: 'border-brand', text: 'text-brand', icon: '✓' },
    ...
    return (
      <div className={`${c.bg} border ${c.border} rounded-[10px] p-6`}>
        ...
        <button
          onClick={recommencer}
          className="text-[13px] text-slate hover:text-navy underline"
        >
  ...
  return (
    <div className="border border-edge rounded-[10px] p-6 bg-white">
      <div className="flex items-center justify-between mb-5">
        <p className="text-[12px] font-semibold text-slate uppercase tracking-widest">
      ...
      <div className="w-full bg-edge rounded-full h-1 mb-5">
        <div
      ...
      <p className="text-[16px] font-semibold text-navy mb-4">
