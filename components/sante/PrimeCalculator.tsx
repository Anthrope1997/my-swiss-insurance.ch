    ...
    <section id="calculateur" className="scroll-mt-24">
      ...
      {results && (
        <div className="space-y-3">
          {/* Result 1 — free */}
          <div className="bg-blue-tint rounded-[8px] px-5 py-4 flex items-center justify-between">
          ...
          {/* Results 2 & 3 — blurred */}
          {[1, 2].map((i) => (
            <div key={i} className="relative rounded-[8px] border border-edge overflow-hidden">
          ...
          {!unlocked ? (
            <div className="bg-white border border-brand rounded-[8px] p-6 mt-4">
            ...
            <div className="bg-blue-tint rounded-[8px] p-4 flex items-center gap-3 mt-4">
