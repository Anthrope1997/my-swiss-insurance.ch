          ...
          <div className="bg-[var(--blue-tint)] border border-brand/20 rounded-[8px] p-4 space-y-3">
            <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
              <div>
                ...
                <p className="text-[16px] font-medium text-ink">{info.revenu}</p>
              </div>
              <div>
                <p className="text-[11px] text-slate uppercase tracking-wide mb-0.5">Montant max.</p>
                <p className="text-[16px] font-medium text-ink">{info.montant}</p>
              </div>
              <div>
                <p className="text-[11px] text-slate uppercase tracking-wide mb-0.5">Attribution</p>
                <p className="text-[16px] font-medium text-ink">{info.auto ? 'Automatique' : 'Sur demande'}</p>
              </div>
              <div>
                <p className="text-[11px] text-slate uppercase tracking-wide mb-0.5">Délai 2026</p>
                <p className="text-[16px] font-medium text-ink">{info.delai}</p>
              </div>
            </div>
            <a href={info.lien} target="_blank" rel="noopener noreferrer"
               className="text-brand hover:underline text-[16px] font-medium inline-block">
              Formulaire officiel →
            </a>
          </div>
        )
        ...
        <>
          ...
          <div>
            ...
            <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
              <div>
                <label className="block text-[16px] text-slate mb-1.5">Situation familiale</label>
                <select
              ...
              <div>
                <label className="block text-[16px] text-slate mb-1.5">Enfants à charge</label>
                <select
              ...
              <div>
                <label className="block text-[16px] text-slate mb-1.5">Âge</label>
                <select
          ...
          <div>
            ...
            <label className="block text-[16px] text-slate mb-1.5">
            ...
            <div className="flex items-center gap-3">
              <input
                ...
                className="input-field max-w-[200px] text-[16px]"
              />
              ...
              {ineligible || noSubside ? (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[16px] text-slate mt-0.5">Votre revenu dépasse le seuil d&apos;éligibilité pour ce canton.</p>
                  </div>
                </div>
              ) : eligible ? (
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-[16px] text-slate mt-0.5">Le montant exact est calculé par le canton sur dossier.</p>
                  </div>
                </div>
              ) : (
